  ...
  return (
    <>
      <button
        ...
        className="absolute top-0 left-2 md:left-4 z-10 bg-stone-700 text-white px-3 py-2 rounded shadow hover:bg-stone-500"
      >
        Filtrar
      </button>
      ...
      <div
        className={`absolute top-0 left-0 w-80 bg-white z-40 shadow-lg transform transition-transform duration-300 ease-in-out rounded-lg ${
          sidebarOpen ? "translate-x-0 mx-1 md:mx-2" : "-translate-x-full"
        }`}
        onKeyDown={(e) => {
