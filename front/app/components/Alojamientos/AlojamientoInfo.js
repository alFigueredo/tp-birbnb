...
export default function AlojamientoInfo({ id }) {
  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-4 md:p-6 w-11/12 md:w-fit max-w-sm md:max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-8">
      <div className="relative w-full md:w-96 h-48 md:h-64 mx-auto lg:mx-0">
